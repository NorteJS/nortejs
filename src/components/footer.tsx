      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            <a href="https://github.com/nortejs" className="text-white hover:text-yellow-400 transition-colors">
              <GithubIcon />
            </a>
        ...
        <div className="mt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} NorteJS. Todos os direitos reservados à comunidade.</p>
        </div>
      </div>
    </footer>
  )
